...
- Reduced Windows command redraw lag further by dropping any frame whose VT generation was already superseded while the renderer was drawing or reading it back, instead of briefly presenting that obsolete frame before the newer prompt/output state.
