...
- Reduced agent-panel session-open stalls by making restored message markdown and persisted reasoning parse lazily instead of eagerly during conversation load.
