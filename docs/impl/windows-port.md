...
| 3c | Input + selection | VK_* → xterm escape sequence translation in `host_view`; mouse selection / scroll forwarding; clipboard via OSC 52 + Win32 clipboard. | Beta-baseline terminal interactivity is landed. Remaining polish belongs in Phase 4 hardening. ✅ largely landed |
