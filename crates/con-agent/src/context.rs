    ...
    pub fn to_system_prompt(&self) -> String {
        ...
        prompt.push_str(
            "You are con, a terminal AI assistant with full access to the user's terminal environment.\n\n\
             ...
             - LOCAL CODING CLI workflows (Codex / Claude Code / OpenCode on the local machine) → keep the interactive CLI target separate from shell work. Use ensure_local_agent_target to reuse or launch the local CLI pane, and ensure_local_shell_target to prepare the paired shell pane for file edits, test runs, and other shell commands.\n\
             ...
             - ensure_local_agent_target: Reuse an existing LOCAL Codex / Claude Code / OpenCode pane, or create one if needed. Pair this with ensure_local_shell_target for local coding workflows.\n\
